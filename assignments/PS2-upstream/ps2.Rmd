...
```{r}
AR_Y1_results <- t(replicate(1000, run_study(1,1)))
AR_Y0_results <- t(replicate(1000, run_study(1,0)))
TX_Y1_results <- t(replicate(1000, run_study(0,1)))
TX_Y0_results <- t(replicate(1000, run_study(0,0)))
```
