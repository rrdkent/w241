...
**Currently Apple is spending nothing, but makes **


**From the perspective of Apple**

$users*conversionrate*unit_profit-(cpi * users)=0$
...
**To calculate the breakeven conversion rate, let' set up an algebra equation**
...
```{r}
coeff <- linear_model$coefficients[2, 1]
stand_error <- regression$coefficients[2, 2]
