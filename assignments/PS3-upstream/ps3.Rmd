...
**I regressed the day 14 temperature on the treatment of ZMapp, vomiting indictor on day 0, the temeprature on day 0, whether the subject was male and the interaction of the treatment of ZMapp and whether the individual was a male.  The results indicate that there is a statistically signficant difference of the treatment effect on a male associated with a coefficent of 3.09 and a p-value of 2*10^(-16), which is super-signficant along with the interaction term of -2.08 with the same p-value.  As I understand it, if we flip on the coefficent associated with treatment of ZMapp (-1.02) and off vomiting day 0, off temperature day 0, on male (1), and on the interaction of treatment and male then the result is a coefficent of (-.23087+3.08549+-2.07669) or a sum of .78, so that the temperature of a man is .78 greater than that of a woman.  Therefore our results suggest that we cannot accept that ZMapp is especially likely to reduce men's temperatures, relative to women's which would just be ZMapp treatment turned on (-.23). **
