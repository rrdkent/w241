...
No, I wouldn't say it would be a consistent estimator, because based upon different samples of a sorted list, it provides very different answers.
...
No, I am not surprised, because as we increase the sample size and it becomes closer and closer to the population size, the sample mean should converge towards the true population m ean.  I'm not surprised (I think) about sample mean 2a and 2b, because that is a function of the randomness of the sample, even though they are the same size.
...
Closer to the truth, because it is a better approximation of the truth which is the mean of population size. (mu versus x-bar)