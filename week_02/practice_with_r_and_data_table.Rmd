...
Consider the following example: Your section instructor, wanting to choose his or her examples to fit in with the pop-culture references that *you* are most familiar with, wants to assess how old you are. But, the section instructor also is not so impolite as to ask you directly. How could they construct an estimate for your age? 
...
```{r}
their_age <- class_population[you == 0, age]
their_age
```
...
```{r}
treat_sample <- sample(d[,y_1],2)
treat_mean <- mean(treat_sample)
treat_mean
```
